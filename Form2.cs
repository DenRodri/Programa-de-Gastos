...
namespace Programacion
{
    public partial class Form2 : Form
    {
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            string resultado = oMoneda.Convertir(RDTB.Text, true, "PESOS");
            Fechalb.Text = DateTime.Now.ToString("d");
            Horalb.Text = DateTime.Now.ToString("hh:mm tt");
            RDlb.Text = resultado;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            bitmap = new Bitmap(size.Width + 75, size.Height + 75, graphics);
            graphics = Graphics.FromImage(bitmap);
            Point point = PointToScreen(panel.Location);
            graphics.CopyFromScreen(point.X + 75, point.Y + 75, 100, 100, size);
